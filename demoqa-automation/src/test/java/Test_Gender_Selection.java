...
public class Test_Gender_Selection extends BaseTest{
    ...
    public void check_male_radio_button(){
        ...
        Assertions.assertTrue(practiceFormPage.genderSection().isRadioButtonChecked(GenderSection.Genders.MALE), "Tıklanmadı");
    ...
    public void check_female_radio_button(){
        ...
        Assertions.assertTrue(practiceFormPage.genderSection().isRadioButtonChecked(GenderSection.Genders.FEMALE),"Tıklanmadı");
    }
    @Test
    public void check_other_radio_button(){
        PracticeFormPage practiceFormPage=new PracticeFormPage(driver);
        practiceFormPage.genderSection().clickRadioButton(GenderSection.Genders.OTHER);
        Assertions.assertTrue(practiceFormPage.genderSection().isRadioButtonChecked(GenderSection.Genders.OTHER),"Tıklanmadı");
    }
}
